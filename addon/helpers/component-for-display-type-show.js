...
export default helper(function componentForDisplayTypeShow(displayTypeUri) {
  const mapping = {
    ...
    'http://lblod.data.gift/display-types/urlOrFilePartFile': `rdf-input-fields/files/show`,
    'http://lblod.data.gift/display-types/urlOrFilePartUrl': `custom-submission-form-fields/remote-urls/show`,
