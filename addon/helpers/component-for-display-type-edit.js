...
export default helper(function componentForDisplayTypeEdit(displayTypeUri) {
  const mapping = {
    ...
    'http://lblod.data.gift/display-types/urlOrFilePartFile': `rdf-input-fields/files/edit`,
    'http://lblod.data.gift/display-types/urlOrFilePartUrl': `custom-submission-form-fields/remote-urls/edit`,
