...
export const estimatedCostTableBaseUri = 'http://lblod.data.gift/id/subsidie/bicycle-infrastructure/table';
export const bicycleInfrastructureUri = 'http://lblod.data.gift/vocabularies/subsidie/bicycle-infrastructure#';
...
export const EstimatedCostTableType = new rdflib.NamedNode(`${bicycleInfrastructureUri}EstimatedCostTable`);
export const EstimatedCostEntryType = new rdflib.NamedNode(`${bicycleInfrastructureUri}EstimatedCostEntry`);
export const estimatedCostTablePredicate = new rdflib.NamedNode(`${bicycleInfrastructureUri}estimatedCostTable`);
export const estimatedCostEntryPredicate = new rdflib.NamedNode(`${bicycleInfrastructureUri}estimatedCostEntry`);

export const descriptionPredicate = new rdflib.NamedNode(`${bicycleInfrastructureUri}costEstimationType`);
export const costPredicate = new rdflib.NamedNode(`${bicycleInfrastructureUri}cost`);
export const sharePredicate = new rdflib.NamedNode(`${bicycleInfrastructureUri}share`);
export const indexPredicate = new rdflib.NamedNode(`${extBaseUri}index`);
export const validEstimatedCostTable = new rdflib.NamedNode(`${bicycleInfrastructureUri}validEstimatedCostTable`);
export const optionsPredicate = new rdflib.NamedNode('http://lblod.data.gift/vocabularies/forms/options');
...
export default class CustomSubsidyFormFieldsEstimatedCostTableBaseTableComponent extends InputFieldComponent {
    ...
    if (triples.length) {
      ...
      if (entriesTriples.length > 0) {
        for (let entry of entriesTriples) {
          ...
          estimatedCostEntries.push(new EstimatedCostEntry({
