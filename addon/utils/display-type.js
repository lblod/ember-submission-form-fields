...
import ParagraphComponent from '@lblod/ember-submission-form-fields/components/rdf-input-fields/paragraph';
// Search components
...
registerComponentsForDisplayType([
  ...
  {
    displayType: 'http://lblod.data.gift/display-types/paragraph',
    edit: ParagraphComponent,
  },
  {
